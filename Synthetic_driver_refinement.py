...
for alg in algorithms:
    ...
    for v in data:
        ...
        drivers.append(int(driver * updated_driver/ old_driver))
        emission.append(e)
        waiting.append(w)
    ...
    for driver in drivers:
        if driver <= 200 * updated_driver/ old_driver:
            final_n += 1
    ...
    if alg == "TORA":
        alg_name = "TORA"
    result[alg_name] = {}
    result[alg_name]['drivers'] = drivers[:final_n]
...
with open('results/Synthetic_drivers/results.json', 'w') as writer:
