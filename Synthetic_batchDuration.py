...
# set_of_values = [int(v) for v in np.arange(60, 430, 30)]
set_of_values = [int(v) for v in np.arange(60, 430, 30)]
...
for alg_name in algorithms:
    ...
    for interval_time in set_of_values:
        ...
        for trial in range(trials):
            ...
            # request_periods = [pd.Timestamp('2016-12-1'), pd.Timestamp('2016-12-3')]
    ...
    with open('results/Synthetic_batchDuration/{0}.json'.format(alg_name), 'w') as writer:
